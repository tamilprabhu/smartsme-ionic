...
export class ProductionShiftService {
    ...
    getProductionShifts(
        ...
        return this.http
            .get<ProductionShiftResponse>(url, {
    ...
    getProductionShift(id: number): Observable<ProductionShift> {
        return this.http
            .get<ProductionShift>(`${this.API_URL}/${id}`, {
                headers: this.getHeaders(),
            })
            .pipe(catchError((error) => throwError(() => error)));
    }
    ...
    createProductionShift(productionShift: Partial<ProductionShift>): Observable<ProductionShift> {
        return this.http
            .post<ProductionShift>(this.API_URL, productionShift, {
                headers: this.getHeaders(),
            })
            .pipe(catchError((error) => throwError(() => error)));
    }
    ...
    updateProductionShift(
        id: number,
        productionShift: Partial<ProductionShift>,
    ): Observable<ProductionShift> {
        return this.http
            .put<ProductionShift>(`${this.API_URL}/${id}`, productionShift, {
                headers: this.getHeaders(),
            })
            .pipe(catchError((error) => throwError(() => error)));
    }
