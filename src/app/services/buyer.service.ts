...
export class BuyerService {
  ...
  createBuyer(buyer: Omit<Buyer, 'buyerSequence' | 'createdAt' | 'updatedAt'>): Observable<Buyer> {
  ...
  updateBuyer(id: number, buyer: Partial<Omit<Buyer, 'buyerSequence' | 'createdAt'>>): Observable<Buyer> {
