...
export class EmployeeService {
    ...
    createEmployee(
        employee: Omit<Employee, 'employeeSequence' | 'createdAt' | 'updatedAt'>,
    ): Observable<Employee> {
        return this.http
            .post<Employee>(this.API_URL, employee, {
                headers: this.getHeaders(),
            })
            .pipe(catchError((error) => throwError(() => error)));
    }
    ...
    updateEmployee(
        id: number,
        employee: Partial<Omit<Employee, 'employeeSequence' | 'createdAt'>>,
    ): Observable<Employee> {
        return this.http
            .put<Employee>(`${this.API_URL}/${id}`, employee, {
                headers: this.getHeaders(),
            })
            .pipe(catchError((error) => throwError(() => error)));
    }
    ...
    getEmployeesByRole(
        ...
        return this.http
            .get<EmployeeDropdownResponse>(url, {
                headers: this.getHeaders(),
            })
            .pipe(catchError((error) => throwError(() => error)));
    }
    ...
    getEmployeeRegistrations(
        ...
        return this.http
            .get<EmployeeWithUserResponse>(url, {
                headers: this.getHeaders(),
            })
            .pipe(catchError((error) => throwError(() => error)));
    }
    ...
    getEmployeeRegistration(employeeSequence: number): Observable<EmployeeWithUserItem> {
        return this.http
            .get<EmployeeWithUserItem>(`${this.API_URL}/${employeeSequence}`, {
                headers: this.getHeaders(),
            })
            .pipe(catchError((error) => throwError(() => error)));
    }
    ...
    createEmployeeRegistration(
        payload: CreateEmployeeWithUserPayload,
    ): Observable<EmployeeWithUserItem> {
        return this.http
            .post<EmployeeWithUserItem>(`${this.API_URL}`, payload, {
                headers: this.getHeaders(),
            })
            .pipe(catchError((error) => throwError(() => error)));
    }
    ...
    updateEmployeeRegistration(
        ...
        return this.http
            .patch<EmployeeWithUserItem>(`${this.API_URL}/${employeeSequence}`, payload, {
                headers: this.getHeaders(),
            })
            .pipe(catchError((error) => throwError(() => error)));
    }
    ...
    deleteEmployeeRegistration(employeeSequence: number): Observable<void> {
        return this.http
            .delete<void>(`${this.API_URL}/${employeeSequence}`, {
                headers: this.getHeaders(),
            })
            .pipe(catchError((error) => throwError(() => error)));
    }
