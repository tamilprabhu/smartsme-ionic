...
export class SellerService {
  private readonly API_URL = `${API_BASE_URL}/seller`;
  ...
  createSeller(seller: Omit<Seller, 'sellerIdSeq' | 'createDate' | 'updateDate'>): Observable<Seller> {
  ...
  updateSeller(id: number, seller: Partial<Omit<Seller, 'sellerIdSeq' | 'createDate'>>): Observable<Seller> {
