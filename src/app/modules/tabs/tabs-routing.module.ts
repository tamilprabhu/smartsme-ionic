...
const routes: Routes = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                loadChildren: () =>
                    import('../profile-masters/profile-masters.module').then(
                        (m) => m.ProfileMastersPageModule,
                    ),
                canActivate: [ModuleAccessGuard],
                data: {
                    anyModuleKeys: [
            ...
            },
            {
                ...
                loadChildren: () =>
                    import('../production-shift/production-shift.module').then(
                        (m) => m.ProductionShiftModule,
                    ),
                canActivate: [ModuleAccessGuard],
