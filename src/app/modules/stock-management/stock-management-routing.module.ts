...
const routes: Routes = [
  ...
  {
    path: 'create',
    loadChildren: () => import('./stock-create/stock-create.module').then((m) => m.StockCreateModule)
  },
  {
    path: ':id/edit',
    loadChildren: () => import('./stock-update/stock-update.module').then((m) => m.StockUpdateModule)
  },
  {
    path: ':id',
