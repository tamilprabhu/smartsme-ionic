...
const routes: Routes = [
  ...
  {
    path: 'create',
    loadChildren: () => import('./buyer-create/buyer-create.module').then((m) => m.BuyerCreateModule)
  },
  {
    path: ':id/edit',
    loadChildren: () => import('./buyer-update/buyer-update.module').then((m) => m.BuyerUpdateModule)
  },
  {
    path: ':id',
